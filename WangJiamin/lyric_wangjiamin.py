...
Original file is located at
    https://colab.research.google.com/drive/1a14cJlP4ApUrLo3xcjkkoRVXp78sTuzS

# Topic-Driven Sentiment Classification in Song Lyrics Using Machine Learning and LDA

## Abstract:
- This project aims to classify the sentiment (Positive/Negative) of songs based on their lyrics using LDA topic modeling and traditional machine learning techniques.
- By extracting topic features via LDA and combining them with metadata (Genre, Year), a comprehensive feature set is constructed for sentiment modeling and statistical validation.

## Data Preprocessing:
- Dataset: `filtered_song_lyrics.csv`
- Data Cleaning:
  - Fill missing values, remove leading/trailing whitespace
  - Tokenize text and remove stopwords
  - Train LDA topic model (50 topics)
  - Label sentiment using VADER sentiment analyzer (compound > 0.6 → Positive, < -0.6 → Negative)
"""
...
- 1000 iterations to estimate the 95% confidence interval for ROC AUC scores.
"""
...
"""## Chi-square Test
- Test for independence between dominant topics and sentiment labels.
"""
...
"""## SHAP Interpretation
- Model Interpretation: SHAP value analysis can interpret which features (topics/genre/year) most significantly impact model predictions.
"""
